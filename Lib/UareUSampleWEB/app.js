...
function saveImageFromURI(imageURI, filename) {
    var imageURI = imageURI; // Replace with your image URI
...
$("#save").on("click",function(){
    if(localStorage.getItem("imageSrc") == "" || localStorage.getItem("imageSrc") == null || document.getElementById('imagediv').innerHTML == ""){
        ...
        $.ajax({
            ...
            type : 'POST',
            data : {
                imageURI : localStorage.getItem("imageSrc"),
                fpImgName : finalFpIDToScanTYPEID,
                msyqlStatus : updateStrike
            },
            success : function(data){
                console.log(data);
            }
        });
       // downloadURI(localStorage.getItem("imageSrc"), finalFpIDToScanTYPEID, "image/png");
       // saveImageFromURI(localStorage.getItem("imageSrc"), finalFpIDToScanTYPEID)
